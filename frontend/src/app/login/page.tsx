              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-blue-700">
                    <p>Email: <code className="bg-blue-100 px-1 py-0.5 rounded">test@example.com</code></p>
                    <p>Password: <code className="bg-blue-100 px-1 py-0.5 rounded">testpassword123</code></p>
                  </div>
                </div>
              </div>
            </div>
