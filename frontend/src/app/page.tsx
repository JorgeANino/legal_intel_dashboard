            ...
            {isLoading ? (
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
                {[...Array(2)].map((_, i) => (
                  <div
                    key={i}
                    className='bg-white p-6 rounded-lg shadow-sm border border-gray-200 h-96 animate-pulse'
                  >
              ...
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
                <div className='bg-white p-6 rounded-lg shadow-sm border border-gray-200'>
                  ...
                  <table className='min-w-full'>
                    ...
                    <tbody>
                      {Object.entries(stats.industries).map(
                        ([industry, count]) => (
                ...
                <div className='bg-white p-6 rounded-lg shadow-sm border border-gray-200'>
                  ...
                  <table className='min-w-full'>
                    ...
                    <tbody>
                      {Object.entries(stats.geographies).map(
                        ([geography, count]) => (
